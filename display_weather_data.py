...
def display_weather_data(data_dict):
    print("-------------------------------------------------")
    print("location: " + str(zip_code_from_coords(data_dict["coord"]["lat"], data_dict["coord"]["lon"])))
    print("coordinates: " + str(data_dict["coord"]["lon"]) + "," + str(data_dict["coord"]["lat"]))
    ...
    print("visibility (in meters, max is 10000): " + str(data_dict["visibility"]))
